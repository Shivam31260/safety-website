...
def facemask_model(conf_threshold=0.6, iou_threshold=0.45):
    """
    Load the YOLOv5 facemask detection model with the specified settings.
    ...
    try:
        ...
        print(f"Facemask model loaded successfully with conf={conf_threshold}, iou={iou_threshold}")
        return model
    except Exception as e:
        print(f"Error loading facemask model: {e}")
        raise e
